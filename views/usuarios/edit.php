          ...
          <div class="widget-content nopadding">
          	    <form class="form-horizontal" method="post" action="editar_usuario" id="edit_user" novalidate="novalidate">
	                ...
	                <label class="control-label">Estado</label>
		          	      	<div class="controls">
			                <select  style="width:220px;" name="activo" class="se_activo" >					                	
			                			  <option id="" value="1">Activo</option>
			                			  <option id="" value="2">Inactivo</option>           	
...
jQuery(document).ready(function($) {
	$('.se_activo option[value=<?php echo $usuario["estado"]; ?>]').attr('selected','selected');
